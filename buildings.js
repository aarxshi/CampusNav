...
const BUILDINGS = {
  1:  { name:'Building 1',  type:'Academic',  depts:['Heritage building'],                                                    img:null },
  ...
  5:  { name:'Building 5',  type:'Academic',  depts:['Mechanical Engineering'],                                               img:null },
  6:  { name:'Building 6',  type:'Academic',  depts:['Mechanical Lab Complex'],                                               img:null },
  7:  { name:'Building 7',  type:'Academic',  depts:['Electrical Engineering','Biological Science'],                          img:null },
  8:  { name:'Building 8',  type:'Academic',  depts:['Industrial Engineering & Management'],                                  img:null },
  9:  { name:'Building 9',  type:'Academic',  depts:['Chemical Engineering','Chemistry'],                                     img:null },
  ...
  13: { name:'Building 13', type:'Academic',  depts:['Arts, Science & Commerce','Journalism','Junior Business School (DSJBS)','MCA (VTU)','RIIC'], img:null },
  14: { name:'Building 14', type:'Academic',  depts:['Architecture','Aeronautical Engineering'],                              img:null },
  ...
  21: { name:'Building 21', type:'Hostels',   depts:['Ladies Hostel 3 – Nelson Mandela'],                                     img:null },
  22: { name:'Building 22', type:'Academic',  depts:['Electronics & Instrumentation','Medical Electronics'],                  img:null },
  23: { name:'Building 23', type:'Hostels',   depts:['Boys Hostel – Sardar Patel Hostel'],                                    img:null },
  24: { name:'Building 24', type:'Academic',  depts:['Diploma'],                                                              img:null },
  25: { name:'Building 25', type:'Academic',  depts:['Dental College','DSU'],                                                 img:null },
  26: { name:'Building 26', type:'Amenities', depts:['Conveno','Facilities'],                                                 img:null },
  // 27 and PC Sagar are the same physical building
